...
CPT_DATASET_INFO = {
    ...
    # },
    "musicpile": {
        "cpt_lr": [5e-5, 6e-5, 7e-5, 8e-5, 9e-5, 1e-4, 1.25e-4, 1.5e-4, 2e-4],
        "cpt_token": [50],
    },
    # "siqa": {
    ...
    # },
    "stackmathqa": {
        "cpt_lr": [2e-5, 3e-5, 4e-5, 5e-5, 6e-5, 8e-5, 1e-4, 1.5e-4, 2e-4],
        "cpt_token": [50],
    },
    "tulu": {
        "cpt_lr": [2e-6, 3e-6, 4e-6, 5e-6, 6e-6, 7e-6, 8e-6, 1e-5, 2e-5, 3e-5],
        "cpt_token": [50],
    },
    "meta-math": {
        # "cpt_lr": [2e-5, 4e-5, 4.5e-5, 5e-5, 5.5e-5, 6e-5, 7e-5, 8e-5, 1e-4, 2e-4],
        "cpt_lr": [4e-5, 5e-5, 6e-5, 7e-5, 8e-5, 9e-5, 1e-4, 1.5e-4, 2e-4],
        "cpt_token": [80],
    },
    "magicoder": {
        # "cpt_lr": [2e-5, 4e-5, 8e-5, 1e-4, 1.5e-4, 2e-4, 2.5e-4, 3e-4, 4e-4, 5e-4],
        "cpt_lr": [3e-5, 4e-5, 5e-5, 6e-5, 7e-5, 8e-5, 1e-4, 1.5e-4, 2e-4],
        "cpt_token": [50],
    },
    # "tuluv2": {
...
def build_cpt_models(midtrained_models: ArtifactSet) -> ArtifactSet:
    ...
    for i, dataset in enumerate(["stackmathqa", "musicpile", "tulu"]):
    # for i, dataset in enumerate(["meta-math", "magicoder"]):
    # for i, dataset in enumerate(["tuluv2"]):
        if i == 0:
