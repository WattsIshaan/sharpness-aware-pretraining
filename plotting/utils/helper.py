...
def get_run_info(
    ...
    if anneal:
        ...
        lrs_key = pretrain_lrs or "wsd"
        all_runs = [r for r in all_runs if r.get("pretrain_lrs") == lrs_key and r.get("anneal_optim") == anneal_optim and (r.get("anneal_match") == anneal_match or r.get("anneal_match") == "both")]
