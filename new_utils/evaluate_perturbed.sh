...
# SIGMAS=(0.02 0.025 0.03 0.05 0.075 0.1)
PROJECT="20m-experiments"
...
#                 # MODEL_NAME=OLMo2-${MODEL_SIZE}m-tk${PT_TOKEN}B-${OPTIM}-lr${PT_LR}-wd1e-1-bs256-anneal-ckpt${ckpt_step}-steps${anneal_steps}
#             fi
#             SIGMA_STR=$(format_sigma "$sigma")
#             PERTURBED_MODEL_NAME="${MODEL_NAME}_perturbed_${SIGMA_STR}"
